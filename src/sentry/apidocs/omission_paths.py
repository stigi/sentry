"""Naming a withheld part of the public schema.

A dotted path resolves against a serializer's fields; each field's class
decides what the next segment may name.
"""
