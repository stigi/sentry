"""Withholding part of a serializer from the public API schema.

Omitted parts vanish from the schema and every generated SDK but are still
accepted at runtime. A missing description is not a reason to use this.
"""
